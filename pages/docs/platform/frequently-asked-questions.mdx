...
export const meta = {
  ...
  lastEdited: '2020-08-26T07:14:20.000Z',
}
...
When you connected your Vercel account to your GitHub account, it installed the [Vercel GitHub App](https://github.com/apps/vercel) to your GitHub account and then GitHub notified Vercel that the app was successfully installed.

However, Vercel was unable to retreive the app installation from GitHub, which made it appear as if the [Vercel GitHub App](https://github.com/apps/vercel) was never installed.
