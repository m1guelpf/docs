...
export const meta = {
  ...
  lastEdited: '2020-08-28T14:03:24.000Z',
}
...
Learn more about how deduplication works when creating Deployments through a Git repository and how to customize the behavior [here](/docs/platform/projects#ignored-build-step).
