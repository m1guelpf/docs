...
<Caption>
  ...
  from the{' '}
  <Link href="/docs/runtimes#official-runtimes/node-js/node-js-request-and-response-objects">
    Request and Response objects
  </Link>
  .
</Caption>

The above example echoes the `body`, path `query`, and `cookies`, passed with the request object, as a JSON object using helper methods provided through the [Request and Response](/docs/runtimes#official-runtimes/node-js/node-js-request-and-response-objects).
